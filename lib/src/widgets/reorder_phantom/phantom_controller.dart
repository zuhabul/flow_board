...
class BoardPhantomController extends OverlapDragTargetDelegate
  ...
  final FlowBoardState groupsState;
...
class PhantomGroupItem extends FlowBoardGroupItem {
...
class PassthroughPhantomContext extends FakeDragTargetEventTrigger
  ...
  FlowBoardGroupItem get itemData =>
      dragTargetData.reorderFlexItem as FlowBoardGroupItem;
