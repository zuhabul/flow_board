...
class FlowBoardGroupHeader extends StatefulWidget {
  final double height;
  final Widget? icon;
  final Widget? title;
  ...
  @override
  State<FlowBoardGroupHeader> createState() => _FlowBoardGroupHeaderState();
}

class _FlowBoardGroupHeaderState extends State<FlowBoardGroupHeader> {
  @override
