...
class _MultiBoardListExampleState extends State<MultiBoardListExample> {
  ...
  late FlowBoardScrollController boardController;

  @override
  void initState() {
    boardController = FlowBoardScrollController();
    final group1 = FlowBoardGroupData(id: "To Do", name: "To Do", items: [
      TextItem("Card 1"),
      TextItem("Card 2"),
    ...
    final group2 = FlowBoardGroupData(
      id: "In Progress",
      name: "In Progress",
      items: <FlowBoardGroupItem>[
        RichTextItem(title: "Card 10", subtitle: 'Aug 1, 2020 4:05 PM'),
        TextItem("Card 11"),
      ],
    );

    final group3 = FlowBoardGroupData(
        id: "Done", name: "Done", items: <FlowBoardGroupItem>[]);
  ...
  Widget _buildCard(FlowBoardGroupItem item) {
    if (item is TextItem) {
      return Align(
...
class RichTextItem extends FlowBoardGroupItem {
  final String title;
